...
class DataHandler(QObject):
    ...
    def load_ProbeBasedSettings_to_ui(self,dimension):
        try:
            ...
            self.ui.lineEdit_probeSensitivity.setText("5")
    ...
    def load_IOSettings_to_ui(self):
        try:
            ...
            if io_dict.get("READING_FREEZE", {}).get("Enable") == '0':
                self.ui.toggleButton_readingFreeze.setPixmap(QPixmap("Switcher_OFF.png"))
            elif io_dict.get("READING_FREEZE", {}).get("Enable") == '1':
                self.ui.toggleButton_readingFreeze.setPixmap(QPixmap("toggle_on.png"))
    ...
    def _apply_io_toggle_states(self):
        try:
            update_IOSetting_ReadingFreeze_toggle(self.ui)
    ...
    #         # The status bar below reports success without stopping the GUI in
    #         # a modal dialog.  The refresh signal runs after this save returns.
    ...
    def save_toDatabase_IOSettings(self):
        try:
            ...
            reading_freeze_enable = io_settings_dict.get('READING_FREEZE', {}).get('Enable', '0')
            ...
            # Determine READING_FREEZE value based on radio buttons
            buzzer_value = ""
            ...
            # else:
            #     raise ValueError("READING_FREEZE value not selected.")
            ...
            self.ui.valueObj.IOSettings_dict = self.ui.databaseObj.load_data_to_IOSettings_dict()
            self.ui.valueObj.activeVariables_dict["READING_FREEZE"] = reading_freeze_enable
