from models import SessionLocal, ActiveVariables
...
class Value:
    ...
    #         # saved_program = self.databaseObj.get_last_active_program()
    #             active_program = session.query(ActiveVariables).filter_by(
    #                 Key="ActiveProgramId"
    #             ).first()

    #         if active_program:
    #             last_program = int(active_program.Value)
    #         else:
    #             last_program = 1
    #         self.activeVariables_dict = {
    #             'ActiveProgramId': last_program,
    #             'AUTO_SAVE_READING': {'Enable': '0'},
    #             'READING_FREEZE': {'Enable': '0'},
    ...
    def init_activeVariables_dictionary(self):
        try:
            ...
            self.activeVariables_dict = {
                ...
                'MASTER_GROUPING': {'Enable': '0'},
                'PART_TRACEABILITY': {'Enable': '0'},
                'SAVE_MASTER_CALIBRATION': {'Enable': 'OFF'},
                'RELAY': {'Enable': '0'},
                'TIME_TO_MASTER_SET': {'Enable': '0'},
                'AOCOnOff': 'OFF',
                'AngleCalculationOnOff': 'OFF',
    ...
    def init_IOSettings_dictionary(self):
        try:
            self.IOSettings_dict = {
                    ...
                    'READING_FREEZE': {'Enable': '0', 'Value': 'Ok'},
