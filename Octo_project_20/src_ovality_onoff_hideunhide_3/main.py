...
from Dial_Indicator import DialUIManager
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):#, gif_labels: dict):
        try:
            ...
            self.lineEdit_masterLower.setDisabled(True)
            self.lineEdit_master.setDisabled(True)
            self.lineEdit_masterHigher.setDisabled(True)
           ...
           # self.worker.spi_generated.connect(self.set_master)
            ...
            # self.comboBox_masterType_1.currentTextChanged.connect(
           ...
           # self.init_dial_ui()
            ...
            # self.on_masterType_changed(self.comboBox_masterType_1.currentText())
    ...
    def apply_ProbeBasedSettings_state(self):
        print("apply_ProbeBasedSettings_state CALLED",self.comboBox_ovalityOnOff.currentText())
    ...
    def update_ui_after_programSettings_saved(self):
        ...
        #self.on_masterType_changed()

        # self.Mater_type_ovality_hideUnhide(int(self.valueObj.activeVariables_dict["ActiveProgramId"]))
    ...
    def save_toDatabase_probeBasedSettings(self):
        try:
            ...
            msg.exec_()
    # def Mater_type_ovality_hideUnhide(self, program_id):
    #     with self.databaseObj.SessionLocal() as session:
    #         row = session.query(ProbeBasedSettings).filter_by(
    ...
    #         master_type = row.MasterType.strip()

    #         if master_type == "Single Master" :
    #             self.lineEdit_masterLower.setEnabled(True)
    #             self.lineEdit_master.setEnabled(True)
    #             self.lineEdit_masterHigher.setEnabled(True)
    ...
    def load_ProbeBasedSettings_to_ui(self, dimension):
        try:
            ...
            self.comboBox_masterType.setCurrentIndex()
            ...
            self.comboBox_ovalityOnOff.setCurrentIndex()
            self.comboBox_rangeProbe.setCurrentIndex()
            self.comboBox_methodProbe.setCurrentIndex()
            self.comboBox_caseProbe.setCurrentIndex()
