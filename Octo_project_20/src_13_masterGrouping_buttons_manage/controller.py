...
class AppController(QObject):
    ...
    def __init__(self, main_window, data_handler):
        try:
            ...
            self.P1_masterGrouping = False
            self.P2_masterGrouping = False
            self.P3_masterGrouping = False
            self.P4_masterGrouping = False
    ...
    def handle_grouping_buttons(self):
        ...
        self.P1_masterGrouping = "#ffff8f" in self.ui.masterGroupingChannel_1.styleSheet().lower()
        # print("p1_Flag",self.P1_masterGrouping)
        self.P2_masterGrouping = "#ffff8f" in self.ui.masterGroupingChannel_2.styleSheet().lower()
        # print("p2_Flag",self.P2_masterGrouping)
        self.P3_masterGrouping = "#ffff8f" in self.ui.masterGroupingChannel_3.styleSheet().lower()
        # print("p3_Flag",self.P3_masterGrouping)
        self.P4_masterGrouping = "#ffff8f" in self.ui.masterGroupingChannel_4.styleSheet().lower()
        # print("p4_Flag",self.P4_masterGrouping)

    def get_selected_master_channels(self):
        selected = []

        if self.P1_masterGrouping:
            selected.append("D1")
        if self.P2_masterGrouping:
            selected.append("D2")
        if self.P3_masterGrouping:
            selected.append("D3")
        if self.P4_masterGrouping:
            selected.append("D4")
