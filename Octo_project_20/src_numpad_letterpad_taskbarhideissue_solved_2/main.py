...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):#, gif_labels: dict):
        try:
           ...
           # self.init_dial_ui()
            ...
            # self.load_Higher_lower_value_to_ui(self.valueObj.activeVariables_dict.get('ActiveProgramId', 1))
            # self.load_Higher_lower_value_to_ui(
            #     int(self.valueObj.activeVariables_dict.get('ActiveProgramId', 1))
            # )
    ...
    # def on_keyboard_text(self, text):
    #     if self.current_lineedit:
    #         self.current_lineedit.setText(text)
    #         self.current_lineedit.parentWidget().setFocus()
    ...
    def load_ProbeBasedSettings_to_ui(self, dimension):
        try:
            ...
            self.comboBox_masterType.setCurrentIndex(-1)
            ...
            self.comboBox_ovalityOnOff.setCurrentIndex(-1)
            self.comboBox_rangeProbe.setCurrentIndex(-1)
            self.comboBox_methodProbe.setCurrentIndex(-1)
            self.comboBox_caseProbe.setCurrentIndex(-1)
