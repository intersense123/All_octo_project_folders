...
class Worker(QObject):
    try:
        ...
        # print("factory = ",factory_config.comboBox.currentText())
...
class SPIController(QObject):
    ...
    def __init__(self, main_window, data_handler,app_controller):
        try:
            ...
            # self.factory_popup = FactoryConfig()
            # self.factory_popup.config_changed.connect(self.on_factory_changed)
    ...
    #     self.worker.set_factory_config(config)
