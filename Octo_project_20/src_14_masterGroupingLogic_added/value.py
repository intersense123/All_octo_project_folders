...
class Value:
    ...
    def init_activeVariables_dictionary(self):
        try:
            self.activeVariables_dict = {
                ...
                # 'CycleStopTimer': '0',
                # 'AutoSaveOnOff': '0',
                # 'PartTraceabilityOnOff': '0',
                # 'TimeToMasterSetOnOff': '0',
                # 'MasterGroupingOnOff': '0',
                'AOCOnOff': 'OFF',
    ...
    # Combined ProgramSettings , ProbeBasedSettings , AOCBasedSettings Tables For Dictionary Use
    ...
    #             }
    #     except Exception as e:
    #         print(f"Error initializing ProgramSettings_dict: {e}")
    #         self.ProgramSettings_dict = {}
    def init_mainProgramSettings_dictionary(self):
        self.ProgramSettings_dict = {
            "ProgramSpecificSettings": {
