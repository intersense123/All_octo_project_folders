...
class FactoryConfig(QtWidgets.QDialog, Ui_fact_config):
    def __init__(self, parent=None):
        ...
        self.button_factory_ok.clicked.connect(self.close_window)
    ...
    def close_window(self):
        self.selected_value = self.comboBox.currentText()
        print("Selected value:", self.selected_value)  # ✅ DEBUG
        self.accept()  # ✅ valid for QDialog
