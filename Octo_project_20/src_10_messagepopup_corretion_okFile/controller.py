...
class AppController(QObject):
    ...
    def init_progId_and_dimension(self):
        try:
            ...
            # self.ui.comboBox_programIdSetting.blockSignals(True)
            # self.ui.comboBox_programIdSettings.blockSignals(True)
            ...
            # self.ui.comboBox_programIdSetting.blockSignals(False)
            # self.ui.comboBox_programIdSettings.blockSignals(False)
        except Exception as e:
