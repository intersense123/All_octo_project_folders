...
class UIHandler(QObject):
    ...
    def apply_ProbeBasedSettings_state(self):
        try:
            ...
            print(f"Error in Apply ProbeBased_State:{e}")
    ...
    def linkage_of_ui(self):
        try:
            ...
            #self.ui.button_fowardSettings.clicked.connect(self.ui.linkage_of_forwardSetting)
            #self.ui.button_backSettings.clicked.connect(self.ui.linkage_of_backSettings)
    ...
    def linkage_of_backButton(self):
        try:
            ...
            #     self.ui.stacked.setCurrentIndex(17)
                ...
                self.ui.stacked.setCurrentIndex(8)
            # elif self.ui.stacked.currentIndex() == 20:
            #     self.ui.stacked.setCurrentIndex(8)
    ...
    def linkage_formula_bar(self):
        try:
            ...
            self.ui.button_addFormulaBar.clicked.connect(
                lambda: self.ui.insert_formula_text(self.ui.comboBox_probeFormulaBar.currentText())
            )
            self.ui.button_saveSettingsFormulaBar.clicked.connect(self.ui.save_formula_to_label)
        except Exception as e:
    ...
    def set_labels_to_header(self):
        try:
            ...
            #     self.ui.button_shutdown.hide()
                ...
                self.ui.button_shutdown.hide()
            # elif self.ui.stacked.currentIndex() == 20:
            #     self.ui.label_pageName.setText("Air Saving Settings")
