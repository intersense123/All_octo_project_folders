...
class AppController(QObject):
    ...
    def on_master_finished(self, master_data):
        self.probe_data = master_data
    ...
    def linkage_of_saveButton(self):
        try:
            ...
            if current_index == 6:
                ...
                # self.data.comboBox_ovalityOnOff.blockSignals(True)
                self.data.save_toDatabase_probeBasedSettings()
                # self.data.comboBox_ovalityOnOff.blockSignals(False)
