...
def update_angle_toggle(win):
    ...
    if state == 'ON':
        win.toggelButton_angleCalculation.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggelButton_angleCalculation.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
...
def update_rs232_toggle(win):
    ...
    # Update toggle pixmap
    if state == 'ON':
        win.toggleButton_rs232.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggleButton_rs232.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_autooffcet_toggle(win):
    ...
    if state == 'ON' :
        win.toggleButton_aoc.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggleButton_aoc.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)   
...
def update_networkdatabase_toggle(win):
    ...
    if state == 'ON' :
        win.toggleButton_networkBasedDatabase.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggleButton_networkBasedDatabase.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)   
...
def update_IOSetting_Buzzer_toggle(win):
    ...
    if state == '1':
        win.toggleButton_buzzer.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggleButton_buzzer.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_IOSetting_Relay_toggle(win):
    ...
    if state == '1':
        win.toggelButton_relay.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggelButton_relay.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_IOSetting_CycleStopTimer_toggle(win):
    ...
    if state == '1':
        win.toggelButton_cycleStopTimer.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggelButton_cycleStopTimer.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_IOSetting_AutosaveReading_toggle(win):
    ...
    if state == '1':
        win.toggelButton_autoSaveReading.setPixmap(QPixmap(":/Switcher_On.png"))    
    else:
        win.toggelButton_autoSaveReading.setPixmap(QPixmap(":/Switcher_OFF.png"))
...
def update_IOSetting_PartTraceability_toggle(win):
    ...
    if state == '1':
        win.toggelButton_partTraceability.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggelButton_partTraceability.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_IOSetting_TimetoMasterSet_toggle(win):
    ...
    if state == '1':
        win.toggleButtontimeToSetMaster.setPixmap(QPixmap(":/Switcher_On.png"))
        for w in widgets:
            w.setEnabled(True)
            set_widget_opacity(w, 1.0)
    else:
        win.toggleButtontimeToSetMaster.setPixmap(QPixmap(":/Switcher_OFF.png"))
        for w in widgets:
            w.setDisabled(True)
            set_widget_opacity(w, 0.5)
...
def update_IOSetting_MasterGrouping_toggle(win):
    ...
    if state == '1':
        win.toggleButton_masterGrouping.setPixmap(QPixmap(":/Switcher_On.png"))    
    else:
        win.toggleButton_masterGrouping.setPixmap(QPixmap(":/Switcher_OFF.png"))
