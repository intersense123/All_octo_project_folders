...
class SPCManager:
    def __init__(self, ui):
        try:
            ...
            self.spc_all = {
            1: SPCWidget(SPCBase("D1", [20.000,20.010,20.015,20.020,20.025,20.030,20.042])),
            2: SPCWidget(SPCBase("D2", [20.000,20.010,20.015,20.020,20.025,20.030,20.042])),
            3: SPCWidget(SPCBase("D3", [20.000,20.010,20.015,20.020,20.025,20.030,20.042])),
            4: SPCWidget(SPCBase("D4", [20.000,20.010,20.015,20.020,20.025,20.030,20.042])),
            }
