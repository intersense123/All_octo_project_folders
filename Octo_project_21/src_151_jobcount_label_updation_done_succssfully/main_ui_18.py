...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_dim.setItemText(0, QCoreApplication.translate("MainWindow", u"D1", None))
        self.comboBox_dim.setItemText(1, QCoreApplication.translate("MainWindow", u"ALL", None))
