            ...
            try:
                ...
                if offs < LSL or offs > USL:
                    ...
                    if offs > UOL or offs < LOL:
                        ...
                        print("OUTSIDE AUTO-CORRECTION ZONE")
                        print("NO CNC CORRECTION")
                        print("POPUP")
                        ...
                        if offs > UOL:
                            message = (
                                f"Dimension {dimension} is beyond "
                                f"Upper Offset Limit."
                            )
                        else:
                            message = (
                                f"Dimension {dimension} is below "
                                f"Lower Offset Limit."
                            )
