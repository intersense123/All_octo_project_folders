    ...
    def save_toDatabase_cncList(self):
        try:
            ...
            self.ui.databaseObj.upsert_cnc_list(cncName,ipAddress,portNumber,
                                            cncSelection,controller,Trial_mode)
            #print("CNCMaster settings saved successfully.")
            msg = CustomMessageBox("CNC Machine Data saved successfully.", "success",
                                   parent=self.ui)
            msg.exec_()
            self.ui.status_manager.show(
                    page_index=13,
            ...
            msg = CustomMessageBox("Failed to save CNC Machine Data. Please check inputs and try again.", "error",
                                   parent=self.ui)
            msg.exec_()
            self.ui.status_manager.show(
                    page_index=13,
