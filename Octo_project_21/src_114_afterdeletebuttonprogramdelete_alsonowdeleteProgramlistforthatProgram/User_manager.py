...
class UserManager(QObject):
    ...
    def __init__(self, main_window):
        try:
            ...
            self.ui.button_login.released.connect(self.validate_user)
...
class UserTableDisplay(QObject):
    ...
    def setup_table(self):
        ...
        try:            
            ...
            self.ui.tableview_loginList.setColumnWidth(1, 330)
            self.ui.tableview_loginList.setColumnWidth(2, 330)
