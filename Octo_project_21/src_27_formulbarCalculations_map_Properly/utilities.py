...
class Utilities:
    def __init__(self, label_time, label_date, lineEdit_formulaBar):
    ...
    def validate_formulabar(self):
        ...
        formula = re.sub(r'\b[PD][1-8]\b', '2.5', self.lineEdit_formulaBar.text())

        # print(formula)
        if formula == '' :
            self.lineEdit_formulaBar.setStyleSheet("background-color: red;")
            return
        
        try:
            exec(formula)
            self.lineEdit_formulaBar.setStyleSheet("background-color: green;")
        except:
            self.lineEdit_formulaBar.setStyleSheet("background-color: red;")
    ...
    def update_display(self):
        ...
        try:
            ...
            self.label_date.setText(current_date.toString('dd-MM-yyyy'))
        except Exception as e:
    ...
    def set_system_time_raspberyPi(self):
        ...
        try:
            day = int(self.lineEdit_day.text())
            month = int(self.lineEdit_month.text())
            year = int(self.lineEdit_year.text())
            hour = int(self.lineEdit_hours.text())
            minute = int(self.lineEdit_minutes.text())
