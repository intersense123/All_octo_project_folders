...
class Worker(QObject):
    ...
    def run(self):
        try:
            ...
            self.cleanup()
    def update_responsiveness(self, responsiveness):
        try:
            if hasattr(self, "spi") and self.spi:
                self.spi.responsiveness = responsiveness
                print(f"Updated Responsiveness: {responsiveness}")
        except Exception as e:
            print(f"update_responsiveness error: {e}")
    def stop(self):
        self._running = False
    ...
    def load_responsiveness(self):
        try:
            ...
            if hasattr(self, "worker") and self.worker is not None:
                self.worker.update_responsiveness(Responsiveness)
        except Exception as e:
            print(f"Error in load_responsiveness -> {e}")
