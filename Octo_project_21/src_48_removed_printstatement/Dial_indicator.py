...
"""
    ...
    def set_visibility(self):
        ...
        if self.channel_count == 1:
            ...
            self.ui.label_value1.setGeometry(QRect(60, 20, 270, 100))
            self.ui.label_value2.setGeometry(QRect(460, 20, 270, 100))
            self.ui.label_value3.setGeometry(QRect(250, 200, 270, 100))
            
            self.ui.label_status1.setGeometry(QRect(60, 140, 270, 40))
            self.ui.label_status2.setGeometry(QRect(460, 140, 270, 40))
            self.ui.label_status3.setGeometry(QRect(250, 320, 270, 40))
            ...
            self.ui.label_value1.setGeometry(QRect(60, 20, 270, 100))
            self.ui.label_value2.setGeometry(QRect(460, 20, 270, 100))
            self.ui.label_value3.setGeometry(QRect(60, 200, 270, 100))
            self.ui.label_value4.setGeometry(QRect(460, 200, 270, 100))
            
            self.ui.label_status1.setGeometry(QRect(60, 140, 270, 40))
            self.ui.label_status2.setGeometry(QRect(460, 140, 270, 40))
            self.ui.label_status3.setGeometry(QRect(60, 320, 270, 40))
            self.ui.label_status4.setGeometry(QRect(460, 320, 270, 40))
