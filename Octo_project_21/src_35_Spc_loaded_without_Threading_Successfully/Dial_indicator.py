  ...
  # minimum padding safety
        ...
        def update_graph(self, value):
            try:
                ...
                self.ax.set_xlim(1, self.spc_count)
                self.ax.set_xticks(self.get_dynamic_xticks())
                self.ax.set_ylim(self.limits[0] - self.padding, self.limits[-1] + self.padding)
                # self.ax.set_ylim(self.limits[0], self.limits[-1])
...
class SPCManager:
    ...
    def reset_all_spc(self):
        try:
            ...
            # 🔥 DELETE FROM DB
            self.ui.savedbObj.delete_probe_values(probe_id)
        ...
        try:
            ...
            # ---------------- 2 SPC ----------------
                ...
                if self.spc_2 is not None:
                    ...
                    spcs[1].spc.canvas.setMinimumHeight(150)
                if self.ui.button_mode2.text() == 'SPC' :
                    self.ui.widget_spc2.show()
