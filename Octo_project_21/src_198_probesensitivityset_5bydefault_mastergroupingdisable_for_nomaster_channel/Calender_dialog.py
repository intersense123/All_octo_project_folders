...
class AOCDateCalendar(QtWidgets.QDialog):
    ...
    def _set_style(self):
        try:
            self.setStyleSheet("""
                ...
                #monthPrevButton:clicked,
                #monthNextButton:clicked,
                #yearPrevButton:clicked,
                #yearNextButton:clicked {
    ...
    def _create_ui(self):
        try:
            ...
            print("Calendar UI creation error:", e)
    # =============================================================
    # UPDATE CALENDAR
    # =============================================================
    ...
    def _update_calendar(self):
        try:
            ...
            print(f"Error in _update_calendar: {e}")
    # =============================================================
    ...
    def _calendar_cell_clicked(
        ...
        try:
            ...
            print(f"Error _calendar_cell_clicked -> {e}")
    # =============================================================
    # PREVIOUS MONTH
    # =============================================================
    ...
    def _previous_month(self):
        try:
            ...
            print(f"Error in _previous_month: {e}")
    # =============================================================
    # NEXT MONTH
    # =============================================================
    ...
    def _previous_year(self):
        try:
            ...
            print(f"Error in _previous_year -> {e}")
    # =============================================================
    # NEXT YEAR
    # =============================================================
    ...
    def _update_selected_date(self):
        try:
            ...
            print(f"Error in _update_selected_date -> {e}")
    # =============================================================
