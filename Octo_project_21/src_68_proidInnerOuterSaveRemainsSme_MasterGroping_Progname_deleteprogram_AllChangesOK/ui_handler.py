...
class UIHandler(QObject):
    ...
    #     self.logoPressTimer.timeout.connect(self.open_hiddenPage)
    ...
    #         # Start 5 sec timer
    #         self.logoPressTimer.start(3000)
    ...
    #     # If long press NOT triggered → normal click
    #     if not self.longPressTriggered:
    #         self.ui.stacked.setCurrentIndex(9)


    # def open_hiddenPage(self):
    ...
    def setup_logoLongPress(self):
        ...
        self.longPressTriggered = False
        self.hiddenPassword = "1234"   # Your password
    ...
    def logo_mousePressEvent(self, event):
        ...
        if event.button() == Qt.LeftButton:
            ...
            # Start 5 sec timer
            self.logoPressTimer.start(5000)
    ...
    def askHiddenPassword(self):
        ...
        keypad = PasswordKeypad("1234", self)
