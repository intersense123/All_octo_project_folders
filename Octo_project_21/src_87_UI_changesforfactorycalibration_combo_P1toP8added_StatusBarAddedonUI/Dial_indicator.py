...
class SPCBase:
    ...
    def _cache_background(self):
        ...
        t = time.perf_counter()
        self.canvas.draw()
        print("_cache_background",time.perf_counter() - t)
...
class SPCManager:
    ...
    def apply_layout(self):
        ...
        try:
            ...
            #     50,
            #     lambda: [
            #         self.spc_all[ch].spc._cache_background()
            #         for ch in self.active_channels
            #     ]
            # )
        except Exception as e:
    ...
    def apply_markersize(self,count):
        ...
        for ch in self.active_channels:
            ...
            # spc._cache_background()
            # spc.canvas.draw()
            # spc.background = spc.canvas.copy_from_bbox(spc.ax.bbox)
