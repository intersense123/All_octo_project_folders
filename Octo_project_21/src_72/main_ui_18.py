...
"}")
        ...
        self.horizontalSpacer_84 = QSpacerItem(10, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_35.addItem(self.horizontalSpacer_84)

        self.radioButton_saveMasterDbON = QRadioButton(self.page9)
        self.radioButton_saveMasterDbON.setObjectName(u"radioButton_saveMasterDbON")

        self.horizontalLayout_35.addWidget(self.radioButton_saveMasterDbON)

        self.horizontalSpacer_86 = QSpacerItem(10, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_35.addItem(self.horizontalSpacer_86)

        self.radioButton_saveMasterDbOFF = QRadioButton(self.page9)
        self.radioButton_saveMasterDbOFF.setObjectName(u"radioButton_saveMasterDbOFF")

        self.horizontalLayout_35.addWidget(self.radioButton_saveMasterDbOFF)

        self.horizontalSpacer_85 = QSpacerItem(40, 50, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_saveMasterDbON.setText(QCoreApplication.translate("MainWindow", u"ON", None))
        self.radioButton_saveMasterDbOFF.setText(QCoreApplication.translate("MainWindow", u"OFF", None))
