...
#              dial_label,needle_label,dial, needle, probe="D1", channel_count=1, parent=None):
#         super().__init__(parent)
#         self.mw= main_window
...
#         self.spring_stiffness = 1  #0.8 #0.15  # Spring constant (higher = faster)
...
#         # print("needle svg size :",self.needle_item.boundingRect())
#         self.scene.addItem(self.needle_item)
