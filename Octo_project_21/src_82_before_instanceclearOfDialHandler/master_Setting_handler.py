    ...
    def ok_notok_part_check(self):
        try:
            ...
            for probe, pdata in self.probe_data.items():
                ...
                if probe == "D1":
                    if status == "OK":
                        self.ui.dial_1_anim.set_dial_color("green")
                    elif status == "REWORK":
                        self.ui.dial_1_anim.set_dial_color("yellow")
                    elif status == "NOT OK":
                        self.ui.dial_1_anim.set_dial_color("red")
                if probe == "D2":
                    if status == "OK":
                        self.ui.dial_2_anim.set_dial_color("green")
                    elif status == "REWORK":
                        self.ui.dial_2_anim.set_dial_color("yellow")
                    elif status == "NOT OK":
                        self.ui.dial_2_anim.set_dial_color("red")  
