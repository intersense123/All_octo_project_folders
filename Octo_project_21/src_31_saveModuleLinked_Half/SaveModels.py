...
class SaveDatabaseManager:
    ...
    #     """
    #     Insert a new AOCBasedIds record.
    #     """
    #     session = self.get_session()
    #     try:
    ...
    # def insert_aoc_values(self, aoc_based_id: int, global_counter: int, parameter: str,machine: str, gauge: str, part_name: str, nominal_value: float, tool_no: int, reading: float, correction: float, tool_value: float, date=None) -> int:
    #     """
    #     Insert a new AOCValues record.
    #     """
    #     session = self.get_session()
    #     try:
    #         new_record = self.AOCValues(
