...
"padding: 5px;")
        ...
        self.label_spcDataCount.setMinimumSize(QSize(0, 40))

        self.horizontalLayout_42.addWidget(self.label_spcDataCount, 0, Qt.AlignmentFlag.AlignRight)

        self.lineEdit_spcDataCount = QLineEdit(self.page15)
        self.lineEdit_spcDataCount.setObjectName(u"lineEdit_spcDataCount")
        self.lineEdit_spcDataCount.setMinimumSize(QSize(0, 40))

        self.horizontalLayout_42.addWidget(self.lineEdit_spcDataCount, 0, Qt.AlignmentFlag.AlignLeft)
