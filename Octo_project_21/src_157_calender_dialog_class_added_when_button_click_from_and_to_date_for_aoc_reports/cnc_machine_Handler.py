...
class CNCManager(QObject):
    ...
    def fanuc_write(self, instance, offset_no, column, new_value):
        try:
            ...
            raise
    def save_aoc_values(self, program_id, aoc_id, machine_name, dimension, part_name, nominal, offset_no, offs,
        ...
        try:
            ...
            try:
                ...
                # CSV logging must not interrupt the database correction flow.
                print(f"Error saving AOC correction CSV -> {csv_error}")
