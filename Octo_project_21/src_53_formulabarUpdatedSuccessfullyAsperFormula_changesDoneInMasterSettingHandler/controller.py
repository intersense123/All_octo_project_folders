...
class AppController(QObject):
    ...
    def handle_delete_dimension(self):
        try:
            ...
            # ✅ Update UI properly
            self.update_delete_button_visibility()
            self.data.load_Higher_lower_value_to_ui(int(self.ui.valueObj.activeVariables_dict.get("ActiveProgramId", "1")))
    ...
    def progId_changed_outer(self):
        try:
            ...
            self.ui.comboBox_programIdSetting_Inner.setCurrentText(str(self.ui.valueObj.activeVariables_dict.get("ActiveProgramId", "1")))
            ...
            self.Handle_master_Grouping(int(self.ui.valueObj.activeVariables_dict.get("ActiveProgramId", "1")))
            self.load_as_per_progId()
            self.update_delete_button_visibility()
        except Exception as e:
