...
class CncListDisplay(QObject):
    ...
    def __init__(self, main_window):
        try:
            ...
            self.ui.button_addCncSettings.clicked.connect(self.handle_cncAdd_clicked)
...
""")
    ...
    def handle_cncModify_clicked(self):
        ...
        try:
            ...
            # Store modify state
            self.selected_cnc_id = cnc.id
            self.is_modify_mode = True

            # Load all values
            self.ui.lineEdit_cncName.setText(cnc.CNCName)
            self.ui.lineEdit_cncIpAddress.setText(cnc.IPAddress)
            self.ui.lineEdit_cncPortNumber.setText(str(cnc.PortNumber))
            ...
            self.ui.comboBox_trialMode.setCurrentText(
                cnc.Trial_mode
            )
            ...
            self.ui.tableView_cncList.clearSelection()
            self.ui.tableView_cncList.setCurrentIndex(
                QtCore.QModelIndex()
            )
            ...
            print(f"Error in handle_cncModify_clicked: {e}")
...
class AocHistoryDisplay(QObject):
    ...
    def setup_table(self):
        ...
        try:            
            ...
            self.ui.tableView_AocDataHistory.setColumnWidth(0, 70)
...
# """)
            ...
            # Set row height
            self.ui.tableView_AocDataHistory.verticalHeader().setDefaultSectionSize(30)
    ...
    def load_aoc_history_to_table(self):
        try:
            ...
            for display_id, record in enumerate(aoc_records, start=1):
