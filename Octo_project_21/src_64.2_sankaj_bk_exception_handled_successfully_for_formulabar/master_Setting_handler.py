    ...
    def resolve_formulas(self, formula_list):
        ...
        while True:
            ...
            for i, formula in enumerate(formula_list):
                ...
                # Empty formula -> leave as is
                if formula == "":
                    new_list.append("")
                    continue

                # Self reference (D1=D1, D2=D2...)
                if formula in ("D1", "D2", "D3", "D4"):
                    changed = False
                    new_list.append("")
                    continue
                ...
                def replacer(m):
                    ...
                    if 0 <= idx < len(formula_list):
                        ...
                        # Don't expand self reference
                        if replacement == f"D{idx+1}":
                            return replacement
    ...
    def set_per_formula(self, a, b, c, d, formula_list):
        try:
            ...
            for formula in formula_list:
                ...
                # Formula is only D1/D2/D3/D4 -> ignore
                if formula in ("D1", "D2", "D3", "D4"):
                    values.append(None)
                    continue
                ...
                try:
                    ...
                    print(f"Formula evaluation error: '{real_formula}' -> {e}")
                    result = 0
