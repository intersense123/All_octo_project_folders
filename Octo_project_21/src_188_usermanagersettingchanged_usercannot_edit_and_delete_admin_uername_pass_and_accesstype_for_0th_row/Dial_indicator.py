...
class SPCManager:
    def __init__(self, main_window):
        try:
            ...
            self.ui.button_spcReset.released.connect(self.reset_all_spc)
            self.load_spc()
    ...
    def on_limits_loaded(self, results):
        try:
            ...
            for item in results:
                ...
                spc_widget.spc.set_title(f"{item['dim']} {item['dim_name']}")
            current_program = int(
...
class DialIndicator(QObject):
    def __init__(self, main_window):
        try:
            ...
            self.ui.button_mode1.released.connect(self.set_dimension_1_ui)
            self.ui.button_mode2.released.connect(self.set_dimension_2_ui)
            self.ui.button_mode3.released.connect(self.set_dimension_3_ui)
            self.ui.button_mode4.released.connect(self.set_dimension_4_ui)
