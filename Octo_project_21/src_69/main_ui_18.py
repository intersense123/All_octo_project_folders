...
"}")
        ...
        self.pushButton = QPushButton(self.page10)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(610, 300, 160, 36))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Update Version", None))
