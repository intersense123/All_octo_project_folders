...
class CNCManager(QObject):
    ...
    def _setup_aoc_report_export(self):
        ...
        # self.ui.label_fromDate.mousePressEvent = lambda event: self._select_aoc_report_date("from")
        # self.ui.label_toDate.mousePressEvent = lambda event: self._select_aoc_report_date("to")
        self.ui.button_fromDate.clicked.connect(lambda: self._select_aoc_report_date("from"))
        self.ui.button_toDate.clicked.connect(lambda: self._select_aoc_report_date("to"))
        self.ui.button_export.clicked.connect(self.export_aoc_report)

    # def _select_aoc_report_date(self, date_type):
    #     """Show a calendar and place the selected date in the matching label."""
    #     label = self.ui.label_fromDate if date_type == "from" else self.ui.label_toDate
    #     dialog = QDialog(self.ui)
    #     dialog.setWindowTitle("Select {} date".format(date_type.title()))
    #     layout = QtWidgets.QVBoxLayout(dialog)
    #     calendar = QtWidgets.QCalendarWidget(dialog)
    #     calendar.setGridVisible(True)
    #     selected = QDate.fromString(label.text().strip(), "dd/MM/yyyy")
    ...
    #         label.setText(calendar.selectedDate().toString("dd/MM/yyyy"))
    def _select_aoc_report_date(self, date_type):
        try:
