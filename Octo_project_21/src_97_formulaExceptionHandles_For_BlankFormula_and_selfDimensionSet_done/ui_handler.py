...
class UIHandler(QObject):
    ...
    #             ["/bin/bash", "/home/torizon/app/touch_calibrate.sh"],
    #             capture_output=True,
    #             text=True
    #         )
    ...
    #         # print(f"[CALIB STDOUT] {stdout.decode()}")
    #         # print(f"[CALIB STDERR] {stderr.decode()}")
    #         # print(f"[CALIB EXIT CODE] {process.returncode}")
    #     except Exception as e:
