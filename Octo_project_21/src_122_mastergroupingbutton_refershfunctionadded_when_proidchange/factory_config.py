...
class FactoryConfig(QtWidgets.QDialog, Ui_fact_config):
    ...
    def __init__(self, parent=None,current_factory=None):
        try:
            ...
            self.panel.setFixedSize(200, 230)
            ...
            # Build the UI on the panel instead of the dialog
            self.setupUi(self.panel)
            ...
            self.setStyleSheet("""
                ...
                """)
            # self.setStyleSheet("background-color: #2b2b2b;border: 1px solid grey;")
            self.comboBox.setStyleSheet("background-color: #2b2b2b;color: white;border: 1px solid grey;")
            # self.button_factory_ok.setStyleSheet("color: white;border: 1px solid grey;")
            self.button_factory_ok.setStyleSheet("""
                QPushButton{
                    color: white;
                    border: 1px solid grey;
            ...
            print(f"FactoryConfig __init__ error: {e}")
    ...
    def showEvent(self, event):
        ...
        if parent:
            # Center relative to the parent's SCREEN position
    ...
    def on_ok_clicked(self):
        try:
            ...
            print(f"FactoryConfig on_ok_clicked error: {e}")
