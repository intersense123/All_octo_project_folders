...
class DataHandler(QObject):
    ...
    def update_ui_after_programSettings_saved(self):
        try:
            ...
            # QTimer.singleShot(100, lambda: self.ui.spc_manager.load_program_OnSpc(int(self.ui.valueObj.activeVariables_dict["ActiveProgramId"])))
    ...
    def save_probe_unique_settings(self):
        # save unique string to  build by build_probe_unique_string ProbeBasedIds
        try:
            programId = int(self.ui.valueObj.activeVariables_dict["ActiveProgramId"])

            # 🔴 ALWAYS reload latest settings
            self.ui.valueObj.ProgramSettings_dict = \
            ...
            for dim in dims:
                ...
                # print("UID STRING:", unique_string)
            ...
            print("Error while Saving Probe Unique Settng on Table ProbeBasedId -> {e}")