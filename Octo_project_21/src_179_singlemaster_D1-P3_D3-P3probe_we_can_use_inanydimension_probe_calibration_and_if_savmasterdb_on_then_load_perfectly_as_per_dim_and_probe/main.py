...
from cnc_Listmanager import CncListDisplay,AocHistoryDisplay
...
class MainWindow(QMainWindow,Ui_MainWindow):
    def __init__(self):
        try:
            ...
            self.comboBox_progid.setCurrentText(str(self.valueObj.activeVariables_dict["ActiveProgramId"]))
            self.comboBox_progid_for_aocreports.setCurrentText(str(self.valueObj.activeVariables_dict["ActiveProgramId"]))
            ...
            self.cnc_manager.live_correction_signal.connect(
                self.dial_indicator.show_live_correction
            )
            self.aoc_history_display = AocHistoryDisplay(self)  
    ...
    def closeEvent(self, event):
        try:
            ...
            if hasattr(self, "cnc_manager"):
                self.cnc_manager.cleanup_thread()
            # if self.spc_manager:
