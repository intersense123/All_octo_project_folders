...
class DialHandler(QObject):
    ...
    def __init__(self, main_window, needle_pos_x, needle_pos_y, pivot_point_x, pivot_point_y,
             dial, needle, probe="D1", channel_count=1, parent=None):
        ...
        self.dial_pixmaps = {
            ...
            "yellow": QPixmap(f"/home/torizon/app/src/images/dial-img-yellow-{size}_modified.png"),
            "red":    QPixmap(f"/home/torizon/app/src/images/dial-img-red-{size}.png"),
        }
    
        # self.dial_pixmaps = {
        #     "green": QPixmap("/home/torizon/app/src/images/dial-img-green-380.png"),
        #     "yellow": QPixmap("/home/torizon/app/src/images/dial-img-yellow-380_modified.png"),
        #     "red": QPixmap("/home/torizon/app/src/images/dial-img-red-380.png"),
        # }
        ...
        self.spring_stiffness = 1.3   #0.8 #0.15  # Spring constant (higher = faster)
        self.spring_damping = 0.15  #0.60#0.83 #0.75    # Damping quotient (0-1, lower = more oscillation)
