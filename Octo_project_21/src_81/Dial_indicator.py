...
class DialIndicator(QObject):
    ...
    def __init__(self, main_window):
        try:
            ...
            self._pm = {
                380: QPixmap(u"/home/torizon/app/src/images/dial-img-yellow-380_modified.png"),
                300: QPixmap(u"/home/torizon/app/src/images/dial-img-yellow-300_modified.png"),
                260: QPixmap(u"/home/torizon/app/src/images/dial-img-yellow-260_modified.png"),
            }
            self._needle = {
            ...
            self._geo = {
                ...
                2: {
                    "dial1_Dial":    QRect(0,  0,   331, 165),
                    "needle1_Dial":  QRect(146, 61,  31, 101),
                    "val1_Dial":     QRect(20,  180, 291, 80),
                    "sts1_Dial":     QRect(30,  290, 220, 60),
                    "btn1_Dial":     QRect(280, 295, 90,  50),
                    "val1_Digit":    QRect(50,  60,  291, 101),
                    "sts1_Digit":    QRect(70,  240, 221, 81),
                    "btn1_Digit":    QRect(320, 260, 81,  50),
 
                    "dial2_Dial":    QRect(400, 0,   331, 165),
                    "needle2_Dial":  QRect(549, 61,  31, 101),
                    "val2_Dial":     QRect(420, 180, 291, 80),
                    "sts2_Dial":     QRect(440, 290, 220, 60),
                    "btn2_Dial":     QRect(670, 295, 90,  50),
                    ...
                    if self.ui.button_mode1.text() == 'Dial':
                        ...
                        if not hasattr(self.ui, "dial_1_anim"):
                            self.ui.dial_1_anim = DialHandler(
                                ...
                                dial = "/home/torizon/app/src/images/dial-img-yellow-380_modified.png",
