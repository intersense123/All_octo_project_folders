...
class AppController(QObject):
    ...
    def __init__(self, main_window, data_handler):
        try:
            ...
            self.ui.button_save.pressed.connect(self.linkage_of_saveButton)
            self.ui.button_setDateTime.pressed.connect(self.handle_set_datetime)
            default_style = ("""
                QPushButton {
