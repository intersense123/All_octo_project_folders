...
"border-radius: 1px;")
        ...
        self.verticalSpacer_33 = QSpacerItem(20, 8, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.page29Layout.addItem(self.verticalSpacer_33)
...
"")
        ...
        self.stackedWidget_main.setCurrentIndex(27)
