...
################################################################################
## Form generated from reading UI file 'main_ui_23_new_aoc_new4_withoutstatusbar_2_new.ui'
##
...
"}")
        ...
        self.horizontalSpacer_84 = QSpacerItem(100, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_41.addItem(self.horizontalSpacer_84)

        self.label = QLabel(self.page10)
        self.label.setObjectName(u"label")
        self.label.setFont(font3)

        self.horizontalLayout_41.addWidget(self.label, 0, Qt.AlignmentFlag.AlignRight)

        self.label_ModelNumber = QLabel(self.page10)
        self.label_ModelNumber.setObjectName(u"label_ModelNumber")
        self.label_ModelNumber.setMinimumSize(QSize(100, 35))
        self.label_ModelNumber.setMaximumSize(QSize(16777215, 16777215))
        self.label_ModelNumber.setFont(font3)
        ...
        self.horizontalLayout_41.addWidget(self.label_ModelNumber, 0, Qt.AlignmentFlag.AlignLeft)

        self.horizontalSpacer_85 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_41.addItem(self.horizontalSpacer_85)
        ...
        self.horizontalSpacer_86 = QSpacerItem(100, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_42.addItem(self.horizontalSpacer_86)

        self.label_6 = QLabel(self.page10)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setFont(font3)

        self.horizontalLayout_42.addWidget(self.label_6, 0, Qt.AlignmentFlag.AlignRight)

        self.label_SerialNumber = QLabel(self.page10)
        self.label_SerialNumber.setObjectName(u"label_SerialNumber")
        self.label_SerialNumber.setMinimumSize(QSize(100, 35))
        self.label_SerialNumber.setFont(font3)

        self.horizontalLayout_42.addWidget(self.label_SerialNumber, 0, Qt.AlignmentFlag.AlignLeft)

        self.horizontalSpacer_87 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_42.addItem(self.horizontalSpacer_87)
        ...
        self.horizontalSpacer_88 = QSpacerItem(140, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_43.addItem(self.horizontalSpacer_88)

        self.label_12 = QLabel(self.page10)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setFont(font3)

        self.horizontalLayout_43.addWidget(self.label_12, 0, Qt.AlignmentFlag.AlignRight)

        self.label_VersionNumber = QLabel(self.page10)
        self.label_VersionNumber.setObjectName(u"label_VersionNumber")
        self.label_VersionNumber.setFont(font3)

        self.horizontalLayout_43.addWidget(self.label_VersionNumber, 0, Qt.AlignmentFlag.AlignLeft)

        self.horizontalSpacer_89 = QSpacerItem(40, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_43.addItem(self.horizontalSpacer_89)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_SerialNumber.setText(QCoreApplication.translate("MainWindow", u"309", None))
